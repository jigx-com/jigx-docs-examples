...
| `color`                           | There is a list of colors available. The color is used in combination with the condition `when`. See [Jigx color palette](https://docs.jigx.com/jigx-color-palette) for the available color options.                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `icon`                            | There is a list of icons available, see [Jigx icons](https://docs.jigx.com/jigx-icons) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
