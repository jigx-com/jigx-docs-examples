---
title: number-field
slug: n6VO-number-field
description: Learn how to use the "Number Field" component for inputting numeric values within a specific form component. This mobile-friendly component displays a numeric keyboard and allows customization options like icon and color choice. Find code snippets, exampl
createdAt: Thu Jun 09 2022 19:39:02 GMT+0000 (Coordinated Universal Time)
updatedAt: Mon Nov 04 2024 10:10:24 GMT+0000 (Coordinated Universal Time)
---
...
:::VerticalSplitItem
::Image[]{alt="Number Field Preview" src="https://archbee-image-uploads.s3.amazonaws.com/x7vdIDH6-ScTprfmi2XXX/KwkJpkkJwrkIiXLBfWABo_number.png" size="84" width="1125" height="696" caption="Number Field Preview" position="center" signedSrc="https://archbee-image-uploads.s3.amazonaws.com/x7vdIDH6-ScTprfmi2XXX/KwkJpkkJwrkIiXLBfWABo_number.png"}
:::
::::
...
::Image[]{src="https://archbee-image-uploads.s3.amazonaws.com/x7vdIDH6-ScTprfmi2XXX/ZehuKgdayEDjBvecia7S7_cc-numberfield.png" signedSrc="https://archbee-image-uploads.s3.amazonaws.com/x7vdIDH6-ScTprfmi2XXX/ZehuKgdayEDjBvecia7S7_cc-numberfield.png" size="82" width="2484" height="2501" position="center" caption="Form with number field" alt="Form with number fields"}
...
See the full example using static data in <a href="https://github.com/jigx-com/jigx-samples/blob/main/quickstart/jigx-samples/jigs/jigx-components/number-field/static-data/number-field.jigx" target="_blank">GitHub</a>.
See the full example using dynamic data in <a href="https://github.com/jigx-com/jigx-samples/blob/main/quickstart/jigx-samples/jigs/components/number-field/dynamic-data/number-field-dynamic.jigx" target="_blank">GitHub</a>.
