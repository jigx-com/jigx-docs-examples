...
{% column %}
<figure><img src="../../.gitbook/assets/carousel-overview (1).png" alt="Carousel" width="188"><figcaption><p>Carousel</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
{% columns %}
{% column %}
<figure><img src="../../.gitbook/assets/carousel-image.gif" alt="Basic carousel" width="159"><figcaption><p>Basic carousel</p></figcaption></figure>
{% endcolumn %}
...
{% columns %}
{% column %}
<figure><img src="../../.gitbook/assets/carousel-pagination.gif" alt="Pagination" width="159"><figcaption><p>Pagination</p></figcaption></figure>
{% endcolumn %}
...
children:
  - type: component.section
    options:
      title: Carousel with image & pagination (outside)
      children:
        - type: component.carousel
          options:
            data: =@ctx.datasources.products
...
{% column %}
<figure><img src="../../.gitbook/assets/carousel-contained.gif" alt="Carousel - pagination and contained" width="159"><figcaption><p>Pagination &#x26; contained</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
