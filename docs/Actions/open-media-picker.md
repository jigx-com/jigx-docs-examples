...
**Example:** See the full code example in [GitHub](https://github.com/jigx-com/jigx-samples/blob/main/quickstart/jigx-samples/jigs/jigx-actions/open-media-picker/open-media-picker-action.jigx).

<figure><img src="../../.gitbook/assets/action-openMediaPicker.png" alt="Open media-picker action" width="375"><figcaption><p>Open media-picker action</p></figcaption></figure>
