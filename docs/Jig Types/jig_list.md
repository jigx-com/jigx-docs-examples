...
* The `numberOfColumns` property is only supported when item.type is [component.product-item](../Components/list/product-item.md) or [component.menu-item](../../readme/components/list/menu-item.md) and the list is vertical.
...
* As a list of [menu-items](../../readme/components/list/menu-item.md)
...
* [Related examples (Github)](https://github.com/jigx-com/jigx-samples/tree/main/quickstart/jigx-samples/jigs/jig-types/jig-list)
